...
const resetPasswordRequest = async (req, res, next) => {
  try {
    ...
    await transporter.sendMail({
      from: `"AutoMERNate" ${process.env.EMAIL_FROM}`, // sender address
      to: user.email, // list of receivers
      subject: 'Password Reset - AutoMERNate', // Subject line
      html: `<p>Hi ${user.name},</p>

            <p>We received a password reset request for your AutoMERNate account. Click the link below to set a new password:</p>
